...
public class Get_Taxi extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
    ...
    TextView textViewName1, textViewLicenseNo1, textViewAddress1, textViewMobile1,textViewTaxiNo1,
            ...
            textusername2,textView1,textView2;
    ...
    private void getDrivers() {
     ...
     //   RequestQueue requestQueue = Volley.newRequestQueue(Get_Taxi.this);
        ...
        StringRequest jsonObjectRequest = new StringRequest(Request.Method.POST, driversUrl, new Response.Listener<String>() {
            @Override
            public void onResponse(String  response) {
    ...
    private void showProfile() {
      ...
      //  RequestQueue requestQueue = Volley.newRequestQueue(Get_Taxi.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://6e1e7877.ngrok.io/findmeataxi", new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                loading.dismiss();
    ...
    private void SendInfo(final String s) {
      //  RequestQueue requestQueue = Volley.newRequestQueue(Get_Taxi.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://6e1e7877.ngrok.io/callnow",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
    ...
    private void showDriver(final String user) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://6e1e7877.ngrok.io/showprofile",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                      //  Log.d("Selected Driver Info",response);
                       // Toast.makeText(Get_Taxi.this, response,Toast.LENGTH_LONG).show();
